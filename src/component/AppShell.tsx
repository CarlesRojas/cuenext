...
export default function AppShell({ children }: AppShellProps) {
  ...
  return (
    <ClientOnly>
      {!isMobile && (
        ...
        >
          <LiquidGlass className="relative h-full w-full rounded-3xl bg-neutral-800/40">
            <div className="flex h-full w-full touch-pan-y flex-col items-start justify-between gap-8 overflow-y-auto overscroll-none p-4">
      ...
      <main
        className="relative flex size-full max-h-full min-h-full max-w-full min-w-full touch-pan-y overflow-hidden overflow-y-auto overscroll-none bg-red-500"
        onScroll={onScroll}
        ref={scrollContainer}
      >
