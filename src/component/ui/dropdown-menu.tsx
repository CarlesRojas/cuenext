...
function DropdownMenuItem({
  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        "group/dropdown-menu-item relative flex h-11 cursor-default items-center gap-2 rounded-full px-4 py-2.5 text-sm outline-hidden select-none data-disabled:pointer-events-none data-disabled:opacity-50 data-inset:pl-7 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        'focus:bg-neutral-500/25',
        'data-[variant=destructive]:*:[svg]:text-red-400/80',
        className,
      )}
      {...props}
    />
...
function DropdownMenuSubTrigger({
  ...
  return (
    ...
    >
      {children}
      <FontAwesomeIcon icon={faChevronRight} className="cn-rtl-flip ml-auto" />
    </DropdownMenuPrimitive.SubTrigger>
  )
}
