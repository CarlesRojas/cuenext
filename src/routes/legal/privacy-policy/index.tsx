  ...
  return (
    ...
    >
      ...
      <ul>
        ...
        <li>
          <p>
            <strong>Application</strong> refers to CueNext, the software program provided by the Company.
          </p>
        </li>
        <li>
          <p>
            <strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or
            &quot;Our&quot; in this Agreement) refers to CueNext.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to CueNext, accessible from{' '}
            <a href="https://www.cuenext.app/" rel="external nofollow noopener" target="_blank">
              https://www.cuenext.app/
            </a>
          </p>
        </li>
        <li>
      ...
      <p>
        {"CueNext' use and transfer to any other app of information received from Google APIs will adhere to "}
        <a
      ...
      <ul>
        <li>By email: cuenext@carlesrojas.com</li>
      </ul>
    </main>
  )
}
