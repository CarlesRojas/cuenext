...
function TermsAndConditions() {
  return (
    ...
    >
      ...
      <p>
        These terms and conditions applies to the CueNext app (hereby referred to as &quot;Application&quot;) for mobile
        devices that was created by Pinya Apps (hereby referred to as &quot;Service Provider&quot;) as a Free service.
      </p>
      ...
      <p>
        ...
        data usage during the connection to the application, or other third-party charges. By using the application, you
        accept responsibility for any such charges, including roaming data charges if you use the application outside of
        your home territory (i.e., region or country) without disabling data roaming. If you are not the bill payer for
        the device on which you are using the application, they assume that you have obtained permission from the bill
        payer.
      </p>
      ...
      <p>
        ...
        that while they strive to ensure that it is updated and accurate at all times, they do rely on third parties to
      ...
      <p>
        ...
        Service Provider at cuenext@carlesrojas.com.
      </p>
    </main>
  )
}
